...
<div id="content" class="video_gallery_template home_content container page_content">
    <div class="left_and_sidebar">
        <div id="home_content" class="content_full_width">
        <div class="iow-header-image">
            <img src="https://sportsspectrum.s3.amazonaws.com/live/wp-content/uploads/2022/09/08163923/I-ONCE-WAS-logos-LONG.png">
        </div>
        <div class="header_text">
            <p class="tagline"><em>Stories of life transformation from the pro sports world</em></p>
        <p><em>We’re all in the middle of a story, and whether we admit it or not, we want our stories to matter. It’s those stories of deep and lasting impact that come to life when a person encounters Jesus, and responds to Him by faith. “I Once Was” invites those in the pro sports world to share their own transformational stories, describing the very moment that changed their lives forever.</em></p>
        </div>
            <?php
