    ...
    <div class="row">
        ...
        if ($custom_query->have_posts()) :
            while ($custom_query->have_posts()) : $custom_query->the_post();
                ...
                <div class="a_blog_post col-md-4">
...
//                                echo '<img src="' . get_stylesheet_directory_uri() . '/images/test_photo.png" class="not_visible">';
                            ...
                            ?>
                            <a class="a_post_img_class a_post_image" <?php echo $target?> href="<?php echo $permalink; ?>" style="background-image:url(<?php echo $prevthumb;?>)"></a>
                        </div>
