...
class LeadpagesLogoutPage implements SettingsPage
{
            ...
            <div class="logout_form">
                ...
                <form method="POST" action="admin-post.php">
                    <p>
                        <input
                            type="checkbox"
                            name="agree_to_pages_deactive"
                            id="agree_to_pages_deactivation"
                            class="logout_checkbox"
                        >
                        <label for="agree_to_pages_deactivation">All Leadpages will be inaccessible.</label></p>
                    <p>
                        <input
                            type="checkbox"
                            name="agree_to_leadboxes_deactive"
                            id="agree_to_leadboxes_deactivation"
                            class="logout_checkbox"
                        >
                        <label for="agree_to_leadboxes_deactivation">All Pop-ups will no longer function.</label>
                    </p>
                    ...
                    <p>
                        ...
                        Logging out will not remove my Leadpages and Pop-ups I have setup. <br/>
    ...
    public function registerPage()
    {
        ...
        add_action('admin_post_leadpages_login_form_support_logout', [$this, 'leadpagesSupportLogUserOut']);
    }

    public function leadpagesSupportLogUserOut()
    {
