...
class WelcomeGateController
{
    ...
    {
        $this->welcomeGateId = LeadpageType::getWelcomeGate();
    ...
    {
        setcookie('leadpages-welcome-gate-displayed', '1', time() + 3600 * 24 * 365);
    }

    protected function checkWelcomeGateCookie()
    {
        return isset($_COOKIE['leadpages-welcome-gate-displayed']);
    }
